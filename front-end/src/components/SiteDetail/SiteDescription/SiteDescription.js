    ...
    return (
        ...
        <div className="max-4xl mx-auto p-6 space-y-8 font-poppins">
            <div className="relative">
                ...
                <h2 className="relative bg-white inline-block px-4 text-xl mt-9 mb-9 font-extrabold text-center left-1/2 transform -translate-x-1/2" style={{ left: '10%',  fontSize:'30px'}}>Description</h2>
            </div>
        </div>

        <div className='flex jusitfy-between items start space-x-28'>
            <div className="w-1/2 pr-4 space-y-10">
            ...
            <h3 className="text-xl  mb-4"> Things You can do</h3>
            ...
            tabIndex="0"
          ></iframe>
          <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Open with Google Maps</button>
