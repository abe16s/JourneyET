    ...
    return (
        ...
        <div className="max-4xl mx-auto p-6 space-y-8 font-poppins header">
            <div className="relative">
                ...
                <h2 className="relative bg-white mt-8 mb-8 inline-block px-4 text-xl font-extrabold text-center left-1/2 transform -translate-x-1/2" style={{ left: '10%',  fontSize:'30px'}}>Things to do</h2>
            </div>
        </div>
